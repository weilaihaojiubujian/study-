...
<%
	   ...
	   try{
		      ...
		      for(int i=1;i<=pageSize;i++){  
		    	  ...
		    	  session.setAttribute("article"+i,wenben); %>
		    	    <table>
		    	     <tr> 
 ...
 <br>
 <a href="gongneng.jsp?showPage=1">首页</a>
 <a href="gongneng.jsp?showPage=<%=showPage-1%>">上一页</a>
<% //根据pageCount的值显示每一页的数字并附加上相应的超链接
  for(int i=1;i<=pageCount;i++){
 %>
   <a href="gongneng.jsp?showPage=<%=i%>"><%=i%></a>
<% }
 %> 
 <a href="gongneng.jsp?showPage=<%=showPage+1%>">下一页</a>
 <a href="gongneng.jsp?showPage=<%=pageCount%>">末页</a>
 <!-- 通过表单提交用户想要显示的页数 -->
